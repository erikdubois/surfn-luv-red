...
Initial standalone repo. The **Surfn-Luv-Red** theme was carved out of the monolithic
`erikdubois/surfn` repo so it ships as its own package, `surfn-luv-red-icons-git`, depending on the base
`surfn-icons-git`.

### Technical Details

- `usr/share/icons/Surfn-Luv-Red/` copied verbatim from the monolith; theme dir kept PascalCase
...
- Initial scaffold + usr/share/icons/Surfn-Luv-Red/
